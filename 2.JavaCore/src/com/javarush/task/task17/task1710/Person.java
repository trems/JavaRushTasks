...
public class Person {
    ...
    public String toString() {
        SimpleDateFormat bdOutFormat = new SimpleDateFormat("dd-MMM-yyyy", Locale.ENGLISH);
        String sex = "";
        if (this.sex == Sex.MALE) sex = "м";
        else if (this.sex == Sex.FEMALE) sex = "ж";
        return name + " " + sex + " " + bdOutFormat.format(birthDate);
    }
}
